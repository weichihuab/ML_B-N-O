...
tree = joblib.load("rf_cohesive.joblib")
...
tax.heatmap(ternary_data, style="hexagonal", cmap='Blues', cbarlabel='Predicted cohesive energy (eV/atom)', scientific=False, cb_kwargs=cb_kwargs, vmax=7.0, vmin=4.0)
...
tax.show()
figure.savefig('ternary_cohesive.png',dpi=300)
